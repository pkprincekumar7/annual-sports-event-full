...
from app.routers import event_years as event_years_router
...
app = FastAPI(title="Event Configuration Service", version="0.1.0")
logger = structlog.get_logger("event-configuration-service")
...
app.include_router(event_years_router.router, prefix="/api")
