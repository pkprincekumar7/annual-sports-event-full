...
from app.routers import event_schedule as event_schedule_router
...
logger = structlog.get_logger("scheduling-service")
...
app.include_router(event_schedule_router.router, prefix="/api")
