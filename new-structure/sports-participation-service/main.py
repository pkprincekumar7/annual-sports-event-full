...
from app.routers import coordinators as coordinators_router
...
app = FastAPI(title="Sports Participation Service", version="0.1.0")
logger = structlog.get_logger("sports-participation")
...
app.include_router(sports_router.router, prefix="/api")
app.include_router(captains_router.router, prefix="/api")
app.include_router(coordinators_router.router, prefix="/api")
